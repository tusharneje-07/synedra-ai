...
const agentColors: Record<string, string> = {
  ...
  "Engagement Expert": "bg-[#F0FDF4] text-[#16A34A] dark:bg-[rgba(22,163,74,0.09)] dark:text-[#86EFAC] border border-transparent dark:border-[rgba(22,163,74,0.22)]",
  "CMO Arbitrator": "bg-[#E6F0FF] text-[#002147] dark:bg-[rgba(37,99,235,0.09)] dark:text-[#93C5FD] border border-transparent dark:border-[rgba(37,99,235,0.22)]",
  "Compliance Officer": "bg-[#F3F4F6] text-[#4B5563] dark:bg-[rgba(75,85,99,0.09)] dark:text-[#D1D5DB] border border-transparent dark:border-[rgba(75,85,99,0.22)]",
};
